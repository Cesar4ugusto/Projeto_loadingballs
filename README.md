...
Animação de Loading usando uma parte da bibliotaca JavaScript `GreenSock`, o `TweenMax`.

Para fazer o download da biblioteca siga os passos no site da [GreenSock](https://greensock.com/)
